# php-base - PHP Slim 4 Server library for cafe store api
...
------------ | ------------- | ------------- | -------------
*AbstractMenuApi* | **addMenu** | **POST** /menu | add menu
*AbstractMenuApi* | **getMenu** | **GET** /menu | list menu
*AbstractMenuApi* | **deleteMenu** | **DELETE** /menu/{menuID} | delete menu
*AbstractMenuApi* | **showMenu** | **GET** /menu/{menuID} | show menu
*AbstractMenuApi* | **updateMenu** | **PUT** /menu/{menuID} | update menu
*AbstractOrderApi* | **addOrder** | **POST** /order | add order
*AbstractOrderApi* | **listOrder** | **GET** /order | list order
*AbstractOrderApi* | **deleteOrder** | **DELETE** /order/{orderID} | 
*AbstractOrderApi* | **showOrder** | **GET** /order/{orderID} | show order
*AbstractOrderApi* | **updateOrder** | **PUT** /order/{orderID} | 


## Models

* OpenAPIServer\Model\AddMenu201Response
* OpenAPIServer\Model\AddMenuRequest
* OpenAPIServer\Model\AddOrder201Response
* OpenAPIServer\Model\AddOrderRequest
* OpenAPIServer\Model\GetMenu200ResponseInner
* OpenAPIServer\Model\ListOrder200ResponseInner
* OpenAPIServer\Model\UpdateMenuRequest
* OpenAPIServer\Model\UpdateOrderRequest
